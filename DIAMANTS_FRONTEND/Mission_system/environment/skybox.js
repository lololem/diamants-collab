...
export const SkyboxShaders = {
    ...
    fragment: `
        ...
        void main() {
            ...
            // Clamp below-horizon to horizon color (no blue circle artifact)
            float dirY = max(direction.y, 0.0);
            
            // Enhanced gradient for Provençal sky with warm colors
            float t = dirY * 0.5 + 0.5;
            
            // Add atmospheric perspective based on distance from horizon
            float horizonFade = smoothstep(0.0, 0.4, dirY);
